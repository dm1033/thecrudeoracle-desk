...
import { A as executeRewriteInput, B as isNotFound, D as resolveManifestAssetLink, E as getStylesheetHref, F as isResolvedRedirect, H as require_react, I as parseRedirect, O as resolveManifestCssLink, P as isRedirect, T as getScriptPreloadAttrs, U as require_jsx_runtime, a as isSsrResponse, c as stripSsrResponseBody, f as RouterProvider, i as disposeSsrResponseDetached, j as invariant, k as _getRenderedMatches, n as bindSsrResponseToRequest, o as normalizeSsrResponse, r as defineHandlerCallback, s as replaceSsrResponse, t as renderRouterToStream, z as rootRouteId } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DtY61VU6.mjs");
...
var manifest = {
	"69afe8597ea691f38d2399e26f579faa61dd8f0ef2f1ce052fdf878be9cd926d": {
		functionName: "getTape_createServerFn_handler",
		importer: () => import("./get-tape-gLJlbjMw.mjs")
	},
	"f8084f9931420a75252bce4421d0ceec8d6630fe81e25f8b41b42fff747738a2": {
		functionName: "askOracle_createServerFn_handler",
		importer: () => import("./ask-oracle-CBHiAkf9.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DtQWY0v1.mjs").then((n) => n.t),
