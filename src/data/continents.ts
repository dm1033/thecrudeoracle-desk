...
export type Region = {
  ...
  net: "exporter" | "importer" | "mixed";
  cycle: "short" | "long" | "sustaining" | "downstream" | "demand";
  chokepoints: string[];
  grades: string[];
...
export const WORLD_RESERVES_BN = 1572.459;
export const WORLD_PROD_KBPD = 84533;
export const RESERVES_AS_OF = "End-2025 (OPEC ASB 2026, Table 3.1)";
export const PROD_AS_OF = "January 2026 (EIA, crude + condensate)";
...
export const REGIONS: Region[] = [
  {
    ...
    thesis:
      "This is not a continent, it is the market. Saudi, Iran, Iraq, UAE, Kuwait and Qatar sit on 867 billion barrels — 55% of the OPEC world total. Production is the swing, not the stock. Spare capacity is concentrated in Riyadh. Fiscal breakevens now live in the high double-digits; $100 oil funds Vision 2030, it does not create spare barrels overnight.",
    reservesBn: 867.4,
    reservesShare: 55.2,
    productionKbpd: 27900,
    productionShare: 33.0,
    net: "exporter",
    cycle: "downstream",
    chokepoints: ["Strait of Hormuz", "Bab el-Mandeb", "East-West Pipeline", "Sumed / Suez"],
    grades: ["Arab Light", "Murban", "Basrah Medium", "Kuwait Export", "Iran Heavy", "Qatar Marine"],
    streams: [
      {
    ...
    producers: [
      { name: "Saudi Arabia", reservesBn: 267.2, productionKbpd: 10110, opec: true, noc: "Aramco", fiscalUsdBn: 214, fiscalNote: "2025 oil export revenue (GaStat)", grades: ["Arab Light", "Arab Extra Light"], streams: ["Exports", "PIF", "chemicals"] },
      { name: "Iran", reservesBn: 208.6, productionKbpd: 4030, opec: true, noc: "NIOC", grades: ["Iran Heavy", "Forozan"], streams: ["Sanctions-constrained exports", "domestic refining"] },
      { name: "Iraq", reservesBn: 140.0, productionKbpd: 4391, opec: true, noc: "SOMO / Basra Oil", fiscalUsdBn: 93, fiscalNote: "2025 goods exports, oil ~85–95%", grades: ["Basrah Medium", "Kirkuk"], streams: ["SOMO term", "budget oil"] },
      { name: "UAE", reservesBn: 120.0, productionKbpd: 4010, opec: true, noc: "ADNOC", grades: ["Murban", "Upper Zakum", "Das"], streams: ["Murban ICE", "ADIA", "LNG"] },
      { name: "Kuwait", reservesBn: 101.5, productionKbpd: 2660, opec: true, noc: "KPC", grades: ["Kuwait Export"], streams: ["KPC exports", "KIA"] },
      { name: "Qatar", reservesBn: 25.244, productionKbpd: 1275, noc: "QatarEnergy", grades: ["Qatar Marine", "Al Shaheen"], streams: ["LNG (the real business)", "condensate"] },
      { name: "Oman", reservesBn: 4.825, productionKbpd: 1024, opecPlus: true, noc: "PDO / OQ", grades: ["Oman"], streams: ["Oman sour benchmark", "China term"] },
    ],
    trade: [
    ...
    sources: [
      { name: "OPEC ASB 2026", url: "https://www.opec.org/" },
      { name: "EIA production (Jan 2026)", url: "https://www.eia.gov/international/data/world" },
      { name: "IEA Hormuz note (2025)", url: "https://www.iea.org/" },
      { name: "EIA OPEC Revenues Fact Sheet", url: "https://www.eia.gov/international/content/analysis/special_topics/OPEC_Revenues_Fact_Sheet/" },
    ],
  },
  {
    slug: "north-america",
    ...
    net: "exporter",
    cycle: "short",
    chokepoints: ["Cushing, Oklahoma", "Houston Ship Channel", "Keystone / TMX", "Panama Canal (products/LNG)"],
    grades: ["WTI Midland", "WTI Cushing", "WCS", "MARS", "Maya"],
    streams: [
      {
    ...
    producers: [
      { name: "United States", reservesBn: 41.909, reservesNote: "OPEC ASB conventional; EIA/OGJ higher once tight oil proved is counted", productionKbpd: 13246, noc: "Independents + majors", grades: ["WTI", "WTS", "MARS"], streams: ["Shale FCF", "product exports", "NGL"] },
      { name: "Canada", reservesBn: 5.08, reservesNote: "OPEC conventional only. EI/OGJ ~163–170 bn including oil sands", productionKbpd: 5059, noc: "Producers + Crown royalties", grades: ["WCS", "SYN", "MSB"], streams: ["Oil sands", "TMX", "Alberta royalties"] },
      { name: "Mexico", reservesBn: 5.136, productionKbpd: 1745, opecPlus: true, noc: "Pemex", grades: ["Maya", "Isthmus"], streams: ["Pemex fiscal", "Maya heavy"] },
    ],
    trade: [
    ...
    sources: [
      { name: "EIA (Jan 2026 production)", url: "https://www.eia.gov/" },
      { name: "OPEC ASB 2026", url: "https://www.opec.org/" },
  ...
  },
  {
    ...
    net: "exporter",
    cycle: "short",
    chokepoints: ["Essequibo / Stabroek", "Santos Basin", "Panama Canal", "USGC heavy-sour capacity"],
    grades: ["Merey", "Tupi / Búzios", "Liza", "Castilla", "Oriente"],
    streams: [
      {
    ...
    producers: [
      { name: "Venezuela", reservesBn: 303.701, productionKbpd: 805, opec: true, noc: "PDVSA", grades: ["Merey", "Hamaca"], streams: ["Orinoco", "sanctions JVs"] },
      { name: "Brazil", reservesBn: 16.841, productionKbpd: 3953, opecPlus: true, noc: "Petrobras", grades: ["Tupi", "Búzios", "Lula"], streams: ["Pre-salt", "dividends"] },
      { name: "Guyana", reservesBn: 11.0, reservesNote: "Worldometer / public compilations; not in OPEC 41-country table", productionKbpd: 895, noc: "Stabroek JV", grades: ["Liza"], streams: ["PSC profit oil"] },
      { name: "Ecuador", reservesBn: 8.273, productionKbpd: 480, grades: ["Oriente", "Napo"], streams: ["Fiscal oil"] },
      { name: "Argentina", reservesBn: 3.093, productionKbpd: 873, noc: "YPF", grades: ["Medanito", "Escalante"], streams: ["Vaca Muerta"] },
      { name: "Colombia", reservesBn: 2.035, productionKbpd: 746, noc: "Ecopetrol", grades: ["Castilla", "Vasconia"], streams: ["Heavy exports"] },
    ],
    trade: [
    ...
    sources: [
      { name: "OPEC ASB 2026", url: "https://www.opec.org/" },
      { name: "EIA production (Jan 2026)", url: "https://www.eia.gov/" },
    ],
  },
  {
    slug: "africa",
    ...
    thesis:
      "Africa is not one market. Libya is a reserve giant with a switch that can add or subtract a million barrels on politics. Nigeria is a theft, force-majeure and deepwater story. Algeria is gas first, oil second. Angola is a decline curve with FPSO optionality. The Atlantic Basin still prices Nigerian and Angolan grades off Dated Brent. The revenue stack is NOC offtake, IOC production-sharing, and a tanker book that loves West African loadings when Suez is ugly.",
    reservesBn: 108.3,
    reservesShare: 6.9,
    productionKbpd: 7200,
    productionShare: 8.5,
    net: "exporter",
    cycle: "long",
    chokepoints: ["Libyan ports", "Bonny / Forcados", "Cape of Good Hope rerouting", "Suez / SUMED"],
    grades: ["Bonny Light", "Qua Iboe", "Saharan Blend", "Cabinda", "Es Sider"],
    streams: [
      {
    ...
    producers: [
      { name: "Libya", reservesBn: 48.363, productionKbpd: 1398, opec: true, noc: "NOC", grades: ["Es Sider", "Sharara"], streams: ["NOC offtake", "swing risk"] },
      { name: "Nigeria", reservesBn: 37.01, productionKbpd: 1548, opec: true, noc: "NNPC", grades: ["Bonny Light", "Qua Iboe", "Forcados"], streams: ["Deepwater", "theft losses"] },
      { name: "Algeria", reservesBn: 12.2, productionKbpd: 1170, opec: true, noc: "Sonatrach", grades: ["Saharan Blend"], streams: ["Oil + pipeline gas to Europe"] },
      { name: "Angola", reservesBn: 2.55, productionKbpd: 954, noc: "Sonangol", grades: ["Cabinda", "Girassol"], streams: ["FPSO decline + tiebacks"] },
      { name: "Egypt", reservesBn: 3.3, productionKbpd: 560, noc: "EGPC / EGAS", grades: ["Suez Blend"], streams: ["Suez transit + gas"] },
      { name: "Congo", reservesBn: 1.811, productionKbpd: 260, opec: true, grades: ["Djeno"], streams: ["Offshore"] },
      { name: "Gabon", reservesBn: 2.0, productionKbpd: 220, opec: true, grades: ["Rabi"], streams: ["Mature onshore/offshore"] },
    ],
    trade: [
  ...
  },
  {
    ...
    net: "importer",
    cycle: "sustaining",
    chokepoints: ["Norwegian Continental Shelf", "North Sea pipeline system", "Rotterdam ARA", "Turkish Straits"],
    grades: ["Brent/Forties/Oseberg/Ekofisk (BFOE)", "Johan Sverdrup", "Forties"],
    streams: [
      {
    ...
    producers: [
      { name: "Norway", reservesBn: 5.919, productionKbpd: 1994, noc: "Equinor + SDFI", grades: ["Johan Sverdrup", "Oseberg", "Ekofisk"], streams: ["GPFG", "pipeline gas"] },
      { name: "United Kingdom", reservesBn: 1.3, productionKbpd: 565, grades: ["Forties", "Brent blend remnants"], streams: ["UKCS tax", "decom"] },
      { name: "Denmark", reservesBn: 0.333, productionKbpd: 70, grades: ["Danish North Sea"], streams: ["Late-life"] },
    ],
    trade: [
    ...
    sources: [
      { name: "OPEC ASB 2026", url: "https://www.opec.org/" },
      { name: "EIA production (Jan 2026)", url: "https://www.eia.gov/" },
      { name: "ICE Brent complex", url: "https://www.ice.com/oil" },
      { name: "NSTA", url: "https://www.nstauthority.co.uk/" },
    ],
  },
  {
    slug: "eurasia",
    ...
    thesis:
      "Russia produces like a Gulf state and reserves like a mid-tier one depending on who you believe (OPEC 80 bn, BP/Eni closer to 108). Kazakhstan and Azerbaijan are pipeline geopolitics: CPC and BTC. The revenue stack is Urals discounts, shadow-fleet freight, CPC Blend, and a refined-product export machine that Ukrainian strikes keep hitting. Products tightness is the Eurasia tell in 2026, not crude barrels.",
    reservesBn: 118.6,
    reservesShare: 7.5,
    ...
    net: "exporter",
    cycle: "sustaining",
    chokepoints: ["CPC pipeline", "BTC", "Druzhba", "Baltic / Pacific ports", "Turkish Straits"],
    grades: ["Urals", "ESPO", "Sokol", "CPC Blend", "Azeri BTC"],
    streams: [
      {
    ...
    producers: [
      { name: "Russia", reservesBn: 80.0, reservesNote: "OPEC ASB; BP/Eni nearer 108 bn", productionKbpd: 10027, opecPlus: true, noc: "Rosneft / Gazprom Neft", grades: ["Urals", "ESPO"], streams: ["Seaborne crude", "products", "pipeline gas"] },
      { name: "Kazakhstan", reservesBn: 30.0, productionKbpd: 1280, opecPlus: true, noc: "KazMunayGas", grades: ["CPC Blend", "Tengiz"], streams: ["CPC", "Tengiz expansion"] },
      { name: "Azerbaijan", reservesBn: 7.0, productionKbpd: 620, noc: "SOCAR", grades: ["Azeri BTC"], streams: ["BTC", "Shah Deniz"] },
      { name: "Turkmenistan", reservesBn: 0.6, productionKbpd: 230, grades: ["Turkmen blend"], streams: ["Gas first"] },
    ],
    trade: [
  ...
  },
  {
    ...
    net: "importer",
    cycle: "demand",
    chokepoints: ["Strait of Malacca", "South China Sea", "Lombok", "Hormuz (for inbound)"],
    grades: ["Daqing", "Minas", "Tapis", "Cossack", "Murban inbound"],
    streams: [
      {
    ...
    producers: [
      { name: "China", reservesBn: 34.472, productionKbpd: 4420, noc: "CNPC / Sinopec / CNOOC", grades: ["Daqing", "Shengli"], streams: ["Domestic upstream", "import book"] },
      { name: "India", reservesBn: 4.995, productionKbpd: 564, noc: "ONGC / Reliance refining", grades: ["Mumbai High"], streams: ["Product exports", "GRM"] },
      { name: "Malaysia", reservesBn: 2.7, productionKbpd: 520, noc: "Petronas", grades: ["Tapis"], streams: ["LNG + Tapis"] },
      { name: "Indonesia", reservesBn: 2.287, productionKbpd: 610, grades: ["Minas", "Duri"], streams: ["Mature PSC"] },
      { name: "Vietnam", reservesBn: 4.4, productionKbpd: 310, grades: ["Bach Ho"], streams: ["Offshore"] },
      { name: "Brunei", reservesBn: 1.1, productionKbpd: 90, grades: ["Champion"], streams: ["LNG"] },
    ],
    trade: [
    ...
    sources: [
      { name: "OPEC ASB 2026", url: "https://www.opec.org/" },
      { name: "EIA production (Jan 2026)", url: "https://www.eia.gov/" },
      { name: "India petroleum exports (Sep 2026)", url: "https://www.cnbctv18.com/" },
    ],
  },
  {
    slug: "oceania",
    ...
    net: "mixed",
    cycle: "downstream",
    chokepoints: ["NW Shelf loadings", "Torres Strait", "Asian LNG terminals"],
    ...
    producers: [
      { name: "Australia", reservesBn: 1.803, productionKbpd: 390, noc: "Woodside / Santos", grades: ["Cossack", "NW Shelf"], streams: ["LNG", "condensate"] },
      { name: "Papua New Guinea", reservesBn: 0.16, reservesNote: "Public compilations, small; gas is the book", productionKbpd: 32, grades: ["Kutubu / condensate"], streams: ["PNG LNG"] },
      { name: "New Zealand", reservesBn: 0.03, productionKbpd: 8, grades: ["Maui remnants"], streams: ["Late-life / decom"] },
    ],
    trade: [
...
export const CONTINENT_INDEX = REGIONS.map((r) => ({
  slug: r.slug,
  name: r.name,
  kicker: r.kicker,
